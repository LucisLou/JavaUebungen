...
public class Leetspeak {
    ...
    public static void main(String[] args) {
        ...
        userText = userText.toUpperCase(); //To make this easier and more readable, otherwise all lower case letter have to be added to alphabet and the characters in leet have to be repeated in the string

        for (int i = 0; i < userText.length(); i++) {

            userTextChar = userText.charAt(i);
